...
DROP TABLE IF EXISTS ScoreComponent;
...
-- 14. Bảng BackupLog (Tính năng mới quản lý sao lưu dữ liệu hệ thống)
CREATE TABLE BackupLog (
    backup_id VARCHAR(20) PRIMARY KEY,
    backup_date DATETIME DEFAULT GETDATE(),
    backup_file VARCHAR(500) NOT NULL,
    [status] VARCHAR(20),
    created_by VARCHAR(20),
    CONSTRAINT FK_Backup_Account FOREIGN KEY (created_by) REFERENCES Account(account_id)
);
GO